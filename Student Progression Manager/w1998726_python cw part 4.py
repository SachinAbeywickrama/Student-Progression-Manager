...
Defer_values = [0, 20, 0, 40, 20, 0, 60, 40, 20, 0, 80, 60, 40, 20, 0, 100, 80, 60, 40, 20, 0, 120, 100, 80, 60, 40, 20, 0]                       
...
while True:
    ...
    for i in range (len(Pass_values)):
        if Pass_values[i] == p and Defer_values[i] == d and Fail_values[i] == f:
            ...
            students_marks[str(id)] = result_values      #https://www.w3schools.com/python/python_dictionaries.asp
...
print("part 4")
print()
for key, value in students_marks.items():            #https://stackoverflow.com/questions/40071006/python-2-7-print-a-dictionary-without-brackets-and-quotation-marks
